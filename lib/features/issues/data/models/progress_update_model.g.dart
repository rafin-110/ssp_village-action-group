...
extension GetProgressUpdateModelCollection on Isar {
  IsarCollection<ProgressUpdateModel> get progressUpdateModels =>
      this.collection();
}

const ProgressUpdateModelSchema = CollectionSchema(
  name: r'ProgressUpdateModel',
  id: 3811502689472167559,
  properties: {
  ...
  deserialize: _progressUpdateModelDeserialize,
  deserializeProp: _progressUpdateModelDeserializeProp,
  idName: r'isarId',
  indexes: {
    r'id': IndexSchema(
  ...
  links: {},
  embeddedSchemas: {},
  getId: _progressUpdateModelGetId,
  getLinks: _progressUpdateModelGetLinks,
  attach: _progressUpdateModelAttach,
  version: '3.1.0+1',
);

int _progressUpdateModelEstimateSize(
...
void _progressUpdateModelSerialize(
  ProgressUpdateModel object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
  ...
  writer.writeString(offsets[3], object.issueId);
  writer.writeString(offsets[4], object.notes);
  writer.writeLong(offsets[5], object.progressPercent);
  writer.writeByte(offsets[6], object.syncStatus.index);
}

ProgressUpdateModel _progressUpdateModelDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = ProgressUpdateModel();
...
P _progressUpdateModelDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
const _ProgressUpdateModelsyncStatusEnumValueMap = {
  'pending': 0,
  'syncing': 1,
  'synced': 2,
  'failed': 3,
};
const _ProgressUpdateModelsyncStatusValueEnumMap = {
...
Id _progressUpdateModelGetId(ProgressUpdateModel object) {
...
extension ProgressUpdateModelByIndex on IsarCollection<ProgressUpdateModel> {
  ...
  ProgressUpdateModel? getByIdSync(String id) {
  ...
  Future<List<ProgressUpdateModel?>> getAllById(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
    return getAllByIndex(r'id', values);
  }

  List<ProgressUpdateModel?> getAllByIdSync(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
  ...
  Future<Id> putById(ProgressUpdateModel object) {
    return putByIndex(r'id', object);
  }

  Id putByIdSync(ProgressUpdateModel object, {bool saveLinks = true}) {
    return putByIndexSync(r'id', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllById(List<ProgressUpdateModel> objects) {
...
extension ProgressUpdateModelQueryProperty
    on QueryBuilder<ProgressUpdateModel, ProgressUpdateModel, QQueryProperty> {
  QueryBuilder<ProgressUpdateModel, int, QQueryOperations> isarIdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProgressUpdateModel, String, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProgressUpdateModel, String, QQueryOperations> notesProperty() {
    return QueryBuilder.apply(this, (query) {
